  ...
  public void setColor(GColor color) {
    if (mColorBuffer != null) {
      ...
      if (mColor == null) {
        ...
        mColorBuffer.put(mIndex * 3 + 2, 0);
        mColorBuffer.put(mIndex * 3 + 3, 0);
      } else {
        mColorBuffer.put(mIndex * 3, color.R);
        mColorBuffer.put(mIndex * 3 + 1, color.G);
        mColorBuffer.put(mIndex * 3 + 2, color.B);
        mColorBuffer.put(mIndex * 3 + 3, color.A);
      }
    }
    mColor = new GColor(color);
  }
